...
export function handleConnectionClick(nodeId) {
    if (!window.firstNodeConnection) {
        ...
        // Asignar interfaz para el nodo origen (router, switch, switch_core, wlc, server, ap)
        if (fromNode.data.type === 'router' || fromNode.data.type === 'switch' || fromNode.data.type === 'switch_core' || 
            fromNode.data.type === 'wlc' || fromNode.data.type === 'server' || fromNode.data.type === 'ap') {
        ...
        // Asignar interfaz para el nodo destino (router, switch, switch_core, wlc, server, ap)
        if (toNode.data.type === 'router' || toNode.data.type === 'switch' || toNode.data.type === 'switch_core' || 
            toNode.data.type === 'wlc' || toNode.data.type === 'server' || toNode.data.type === 'ap') {
